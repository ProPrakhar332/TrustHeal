            ...
            <View style={{alignSelf: 'center', width: '90%'}}>
              <View style={{flex: 1}}>
                <Text style={styles.parStyles}>
                  ...
                  to provide on-demand, qualified, affordable, convenient, and
                  secure medical consultations with the best doctors at the
              ...
              <View style={{flex: 1}}>
                <Text style={styles.parStyles}>
                  ...
                  provide access to quality health and medical facilities to
                  every cross section of society by connecting people with
                  specialist doctors, hospitals, clinics, pharmacies,
              ...
              <View style={{flex: 1}}>
                <Text style={styles.parStyles}>
                  ...
                  services in India. The platform's seamless connectivity and
                  easy-to-use interface make it possible for people to access
                  medical consultation with minimal effort and at an affordable
                  price.
                </Text>
              </View>
              <View style={{flex: 1}}>
                <Text style={styles.parStyles}>
                  ...
                  revolutionize the healthcare industry in India by bridging the
