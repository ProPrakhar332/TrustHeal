...
const DoctorRegistration2 = ({ navigation }) => {
  ...
  const removeHandler = (e) => {
    updateQuestionareList(questionareList.filter((obj) => obj.ques !== e));
        ...
        <View style={styles.bubble} key={index}>
          ...
          <FAIcon
            ...
            onPress={() => {
              ...
              removeHandler(questionareList.ques);
            }}
          />
        </View>
      );
                  ...
                  <View style={{ flexDirection: "column", marginVertical: 10 }}>
                    ...
                    <View style={{ flexDirection: "column" }}>
                      ...
                      <TextInput
                        style={styles.textInput}
                        value={ClinicAddress}
                        onChange={(text) => setClinicAddress(text)}
                      />
                    </View>
                  </View>
                  <CustomButton
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <TextInput
                          style={styles.textInput}
                          value={showMobNo}
                          onChange={(text) => setshowMobNo(text)}
                        />
                        <FAIcon
                          name="chevron-down"
                          color={"black"}
                      ...
                      <View style={{ flexDirection: "column", flex: 0.45 }}>
                        ...
                        <TextInput
                          style={styles.textInput}
                          value={showFollowUp}
                          onChange={(text) => setshowFollowUp(text)}
                          keyboardType={"number-pad"}
                        />
                        <FAIcon
                          name="chevron-down"
                    ...
                    <View style={{ flexDirection: "column" }}>
                      <TouchableOpacity
                        ...
                        onPress={() => setshowEconsultMode(!showEconsultMode)}
                      >
                        ...
                        <FAIcon
                          name={
                            !showEconsultMode ? "chevron-down" : "chevron-up"
                          }
                          color={"black"}
                          size={20}
                          style={{
                    ...
                    {showEconsultMode ? (
                      ...
                      >
                        <TouchableOpacity
                          onPress={() => {
                            setbuttonActiveVideo(!buttonActiveVideo);
                            if (buttonActiveVideo) {
                              !EconsultMode.includes("Video")
                                ? EconsultMode.push("Video")
                                : null;
                            } else {
                              let x = EconsultMode.indexOf("Video");
                              // console.log(x);
                              EconsultMode.splice(x, 1);
                            }
                            // console.log(EconsultMode);
                          }}
                          style={[
                            {
                              flexDirection: "row",
                        ...
                        <TouchableOpacity
                          onPress={() => {
                            setbuttonActivePhone(!buttonActivePhone);
                            if (buttonActivePhone) {
                              !EconsultMode.includes("Phone")
                                ? EconsultMode.push("Phone")
                                : null;
                            } else {
                              let x = EconsultMode.indexOf("Phone");
                              // console.log(x);
                              EconsultMode.splice(x, 1);
                            }
                            // console.log(EconsultMode);
                    ...
                    <View style={{ flexDirection: "column" }}>
                      ...
                      >
                        <Text style={styles.label}>
                          Set Pre Consultation Questionnaire
                        </Text>
                        <FAIcon
                          name={!showQuestions ? "chevron-down" : "chevron-up"}
                          color={"black"}
                          size={20}
                          style={{
                            alignSelf: "center",
