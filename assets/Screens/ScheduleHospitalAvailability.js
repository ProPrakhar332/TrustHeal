...
const ScheduleHospitalAvailability = (props) => {
  ...
  useEffect(() => {
    const onLoadSetData = async () => {
      ...
      let slots = '[{"endTime":"10:20","isBooked":false,"isDeleted":true,"slotDate":"2022-11-13","slotId":0,"startTime":"10:00"},{"endTime":"10:50","isBooked":true,"isDeleted":true,"slotDate":"2022-11-13","slotId":0,"startTime":"10:30"},{"endTime":"11:20","isBooked":false,"isDeleted":true,"slotDate":"2022-11-13","slotId":0,"startTime":"11:00"},{"endTime":"11:50","isBooked":true,"isDeleted":true,"slotDate":"2022-11-13","slotId":0,"startTime":"11:30"},{"endTime":"12:20","isBooked":false,"isDeleted":true,"slotDate":"2022-11-13","slotId":0,"startTime":"12:00"},{"endTime":"12:50","isBooked":true,"isDeleted":true,"slotDate":"2022-11-13","slotId":0,"startTime":"12:30"}]'
  ...
  const renderDaysSlot = ({ item }) => {
    return (      
      (item.isActive) ? (
        ...
        >
          <Text style={styles.bubbleTitleActive}>{item.day + "\n" + new Date(item.date).getDate()}</Text>
        </TouchableOpacity>
      ) : (
        <TouchableOpacity
          style={[
          ...
          onPress={() => {setDaysSlotRefresh(!DaysSlotRefresh); setDays(item); DaysSlot.forEach(x => x.isActive = false); item.isActive = true; console.log(JSON.stringify(DaysSlot));}}
        >
  ...
  const renderSlot = ({ item }) => {
    return (
      (item.isBooked) ? (
        ...
        >
          <Text style={styles.slotTitleActive}>{item.startTime} to {item.endTime}</Text>
        </TouchableOpacity>
       ) : (
        <TouchableOpacity
          style={[
          ...
          onPress={() => console.log(item.slotId)}
        >
          <Text style={styles.slotTitle}>{item.startTime} to {item.endTime}</Text>
        </TouchableOpacity>
      )
    );
  };
              ...
              <View>
                <Text
                  style={{
                    ...
                    marginHorizontal: 10,
                    fontSize: 12,
                  }} onPress={() => {setViewSchedulesModal(true);}}
                >
                  View More
                </Text>
              </View>
            ...
            >
              <View style={{ height: "100%", backgroundColor: "rgba(0,0,0,0.8)" }}>
                <View style={[styles.modalView, { flexDirection: "column" }]}>
                  ...
                  <View style={{flexDirection: "row"}}>
                    {ViewEConsultations ? (<Button disabled title="E-Consultation" onPress={() => {}}></Button>) : (<Button color={"#2b8ada"} title="E-Consultation" style={{backgroundColor: "#fff", borderColor: "blue"}} onPress={() => {setViewEConsultations(!ViewEConsultations);setViewPConsultations(!ViewPConsultations);}}></Button>)}
                    {ViewPConsultations ? (<Button disabled title="P-Consultation" onPress={() => {}}></Button>) : (<Button color={"#2b8ada"} title="P-Consultation" style={{backgroundColor: "#fff", borderColor: "blue"}} onPress={() => {setViewEConsultations(!ViewEConsultations);setViewPConsultations(!ViewPConsultations);}}></Button>)}
                  </View>
                  {ViewPConsultations ? (
